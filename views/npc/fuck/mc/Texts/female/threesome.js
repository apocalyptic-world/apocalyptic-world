...
setup.actionText.female = {
    ...
    threesome_m_anal_fisting: [
        "You insert your whole fist into %name%'s asshole!"
    ],
    threesome_m_bj: [
    ...
    threesome_m_cum_in_mouth: [
        "%name2% and you fill %name%'s mouth with your cum."
    ],
    threesome_m_cum_in_pussy: [
        "You continue to fuck %name% non-stop and pump her pussy full of your seed."
    ],
    threesome_m_cum_on_ass: [
        "%name2% and you cum on %name%'s ass."
    ],
    threesome_m_cum_on_back: [
        "%name2% and you cum on %name%'s back side."
    ],
    threesome_m_cum_on_face: [
        "%name2% and you cum all over %name%'s face."
    ],
    threesome_m_cum_on_stomach: [
        "%name2% and you finish on %name%'s stomach."
    ],
    threesome_m_cum_on_tits: [
        "%name2% and you cum all over %name%'s breast."
    ],
    threesome_m_double_cum: [
        "%name% gets both holes filled with %name2% and your cum."
    ],    
    threesome_m_handjob: [
        "%name% gives %name2% and you a nice handjob, a good start!"
    ],
    threesome_m_kissing: [
        "%name2% and you are kissing %name% in turn."
    ],
    threesome_m_nipple_lick: [
        "%name2% and you lick %name%'s nipples, and squeeze her tits hard!"
    ],
    threesome_m_pussy: [
        "You fuck %name%'s tight pussy"
    ],
    ...
    threesome_m_pussy_fingering: [
        "You finger %name% pussy, she is getting very wet!"
    ],
    threesome_m_pussy_lick: [
        "You lick %name%'s clit, she seems to like it a lot!"
    ],
    threesome_m_titjob: [
